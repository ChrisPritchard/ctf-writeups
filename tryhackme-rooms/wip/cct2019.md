...
- decompiling this ghidra will reveal that past some IRC messages, it takes a message encoded in the binary and applies ROT13 to it, before wrapping with CCT{}.
