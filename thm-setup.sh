...
echo "git clone https://github.com/NHAS/reverse_ssh && cd reverse_ssh && make && cd bin/ && cp ~/.ssh/id_ed25519.pub authorized_keys && ./server 0.0.0.0:3232 & && python3 -m http.server 1234 &" > reverse_ssh.sh
